...
if (isset($_GET['hal'])) {
    if ($_GET['hal'] == 'edit') {
        $tampil = mysqli_query($koneksi, "SELECT * FROM kelas_221043 WHERE id_221043 = '$_GET[id]'");
        $data = mysqli_fetch_array($tampil);
        if ($data) {
            $id = $data['id_221043'];
            $kelas = $data['kelas_221043'];
        }
    }
}
...
if (isset($_POST['simpan'])) {
    $simpan = mysqli_query(
        $koneksi,
        "UPDATE kelas_221043 SET
                                        kelas_221043 = '$_POST[kelas]' WHERE id_221043 = '$_GET[id]'",
    );
...
<body id="page-top">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="kelas1"
                                                        value="<?= $kelas ?>" name="kelas" placeholder="Kelas"
                                                        required>
                                                    <div id="kelasError" class="error-message">Kelas harus diisi</div>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const kelas = document.getElementById('kelas1');
