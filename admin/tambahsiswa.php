        ...
        <form method="POST">
          <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="emailortu" name="emailortu" placeholder="Enter email" required>
            </div>
              <div class="form-group">
                <label for="ortuPassword">Password</label>
                <input type="password" class="form-control" id="passwordortu" name="passwordortu" placeholder="Password" required>
              </div>
            </div>
          </div>
