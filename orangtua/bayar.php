                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="ml-2 d-none d-lg-inline text-white small"><?= $_SESSION['nama_orangtua'] ?></span>
                            </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <p class="text-danger">Rp
                                                    <?= number_format($denda_info['total_denda'], 0, ',', '.') ?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="<?= $data['bukti_pembayaran_221043'] ?>"
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="badge badge-warning"><?= $data['status_221043'] ?></span>
                                                    <?php else: ?>
                                                    <span
                                                        class="badge badge-success"><?= $data['status_221043'] ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <button class="btn btn-primary" data-toggle="modal"
                                                        data-target="#uploadModal<?= $data['id_221043'] ?>">
                                                        Upload Foto
                                                    </button>

                                                    <!-- Modal Upload Foto -->
                                                    <div class="modal fade" id="uploadModal<?= $data['id_221043'] ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="upload_foto.php" method="post"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="id_221043"
                                                                            value="<?= $data['id_221043'] ?>">
                                                                        <div class="form-group">
                                                                            <label>Total yang harus dibayar: Rp
                                                                                <?= number_format($total_bayar, 0, ',', '.') ?></label>
                                                                            <?php if ($denda > 0): ?>
                                                                            <div class="alert alert-warning">
                                                                                Terdapat denda keterlambatan sebesar Rp
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Silakan transfer pembayaran ke salah
                                                                                satu rekening berikut:</label>
                                                                            <ul>
                                                                                <li><strong>BCA:</strong> 123456789 a.n.
                                                                                    Najwa</li>
                                                                                <li><strong>BRI:</strong> 987654321 a.n.
                                                                                    Najwa</li>
                                                                                <li><strong>BNI:</strong> 456789123 a.n.
                                                                                    Najwa</li>
                                                                            </ul>
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label for="bukti_pembayaran_221043">Upload
                                                                                Bukti Pembayaran:</label>
                                                                            <input type="file"
                                                                                name="bukti_pembayaran_221043"
